...
6. [[./deployment/index.org][Deployment]]
   

* Completed Tasks
** Milestone-I
   1. Find a software which can solve the problem 
   2. Implement and document the procedure to deploy it 
   3. Integrate it with the VLEAD vagrant box 
...
As we have completed all 3 milestones we have successfully completed the project assigned to us.
