...
<bean id="authenticationManager" class="org.apereo.cas.authentication.PolicyBasedAuthenticationManager">
    ...
    <property name="authenticationMetaDataPopulators">
        <util:list>
           <bean class="org.apereo.cas.support.pac4j.authentication.ClientAuthenticationMetaDataPopulator" />
        </util:list>
    </property>
    <property name="authenticationPolicy">
        <bean class="org.apereo.cas.authentication.AnyAuthenticationPolicy" />
    </property>
</bean>

<bean id="primaryAuthenticationHandler"     
    class="org.apereo.cas.support.pac4j.authentication.handler.support.ClientAuthenticationHandler"
    c:clients-ref="clients">
#+END_SRC


* cas-servlet
  The flow after indentity provider has completed its authentication
  followed by Callback should be defined in the cas-servlet.
  #+BEGIN_SRC :eval no :tangle WEB-INF/cas-servlet.xml
<bean id="clientAction" class="org.apereo.cas.support.pac4j.web.flow.ClientAction"
