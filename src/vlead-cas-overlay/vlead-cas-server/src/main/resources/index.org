...
server.ssl.key-store=file:/home/shubh/oauth-service/build/code/vlead-cas-overlay/public_private_keys/thekeystore
server.ssl.key-store-password=changeit
server.ssl.key-password=changeit
...
* Deployer Configuration 
  Beans for CAS to define the various identity providers
#+BEGIN_SRC :eval :no :tangle deployerConfigContext.xml
